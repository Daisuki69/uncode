...
/**
 * Supervisor-driven: Unified services are declared dynamically in UnifiedPolicyRegistry.kt.
 * No hardcoded service IDs, packages, or domains are stored in frontend types.
 */
